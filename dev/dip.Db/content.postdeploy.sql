...
GO
INSERT [auth].[User] ([Id], [Email], [Password], [FirstName], [LastName], [MiddleName], [Photo], [PhoneNumber], [Status], [CreatedOn], [ModifiedOn], [LastLoginOn]) VALUES (1, N'smetaninatv@yandex.ru', N'1', N'Татьяна', N'Сметанина', NULL, NULL, N'+79031222341', 1, CAST(N'2018-08-12T12:40:26.357' AS DateTime), CAST(N'2018-08-12T12:40:26.357' AS DateTime), CAST(N'2018-11-12T18:24:44.823' AS DateTime))
GO
...
GO
INSERT [logs].[Error] ([Id], [UserId], [ErrorCode], [ErrorMessage], [StackTrace], [CreatedOn], [ModifiedOn]) VALUES (1, 1, 404, N'test', N'long long text', CAST(N'2018-10-05T16:43:00.423' AS DateTime), CAST(N'2018-10-08T16:55:03.610' AS DateTime))
GO
...
GO
SET IDENTITY_INSERT [logs].[Log] ON 

GO
INSERT [logs].[Log] ([Id], [UserId], [ActionType], [PageUrl], [OccurredOn]) VALUES (1, 1, 1, N'/login', CAST(N'2018-10-05T16:43:46.800' AS DateTime))
GO
INSERT [logs].[Log] ([Id], [UserId], [ActionType], [PageUrl], [OccurredOn]) VALUES (2, 1, 2, N'/test', CAST(N'2018-09-29T00:00:00.000' AS DateTime))
GO
SET IDENTITY_INSERT [logs].[Log] OFF
GO
...
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (1, N'CONTACT_EMAIL', N'smetaninatv@yandex.ru', CAST(N'2018-08-28T17:48:58.550' AS DateTime), CAST(N'2018-08-28T17:48:58.550' AS DateTime))
GO
...
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (3, N'CONTACT_URL', N'http://.com', CAST(N'2018-08-28T17:49:19.957' AS DateTime), CAST(N'2018-08-28T17:49:19.957' AS DateTime))
GO
...
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (11, N'DAYS_API_ADDEDIT_URL', N'https://daysinplace.azurewebsites.net/api/days/addEdit', CAST(N'2018-09-16T07:25:54.033' AS DateTime), CAST(N'2018-09-16T07:25:54.033' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (12, N'DAYS_API_GET_URL', N'https://daysinplace.azurewebsites.net/api/days/get?userId={0}&countryId={1}&countryVisaId={2}', CAST(N'2018-09-16T07:26:38.457' AS DateTime), CAST(N'2018-09-16T07:26:38.457' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (13, N'COUNTRY_API_ADDEDIT_URL', N'https://daysinplace.azurewebsites.net/api/country/addEdit', CAST(N'2018-09-16T07:27:03.580' AS DateTime), CAST(N'2018-09-16T07:27:03.580' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (14, N'COUNTRY_API_DELETE_URL', N'https://daysinplace.azurewebsites.net/api/country/delete', CAST(N'2018-09-16T07:27:17.627' AS DateTime), CAST(N'2018-09-16T07:27:17.627' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (15, N'VISA_API_ADDEDIT_URL', N'https://daysinplace.azurewebsites.net/api/usercountryvisa/addEdit', CAST(N'2018-09-16T07:27:36.097' AS DateTime), CAST(N'2018-09-16T07:27:36.097' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (16, N'VISA_API_DELETE_URL', N'https://daysinplace.azurewebsites.net/api/usercountryvisa/delete', CAST(N'2018-09-16T07:27:48.533' AS DateTime), CAST(N'2018-09-16T07:27:48.533' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (18, N'VISA_API_LIST_URL', N'https://daysinplace.azurewebsites.net/api/usercountryvisa/list?userId={0}&countryId={1}', CAST(N'2018-09-16T07:28:16.160' AS DateTime), CAST(N'2018-09-16T07:28:16.160' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (19, N'COUNTRY_API_LIST_URL', N'https://daysinplace.azurewebsites.net/api/country/list?userId={0}', CAST(N'2018-09-16T07:28:48.533' AS DateTime), CAST(N'2018-09-16T07:28:48.533' AS DateTime))
GO
...
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (23, N'DAYS_API_LIST_URL', N'https://daysinplace.azurewebsites.net/api/days/list?userId={0}', CAST(N'2018-10-07T11:26:07.290' AS DateTime), CAST(N'2018-10-07T11:26:07.290' AS DateTime))
GO
...
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (27, N'USER_API_CHANGEPICTURE_URL', N'https://daysinplace.azurewebsites.net/api/user/changePicture', CAST(N'2018-10-07T12:03:08.393' AS DateTime), CAST(N'2018-10-07T12:03:08.393' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (28, N'USER_API_CHANGEPASSWORD_URL', N'https://daysinplace.azurewebsites.net/api/user/changePassword', CAST(N'2018-10-07T12:03:48.833' AS DateTime), CAST(N'2018-10-07T12:03:48.833' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (29, N'USER_API_CHANGEPHONE_URL', N'https://daysinplace.azurewebsites.net/api/user/changePhone', CAST(N'2018-10-07T12:04:00.380' AS DateTime), CAST(N'2018-10-07T12:04:00.380' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (30, N'USER_API_RESTOREPASSWORD_URL', N'https://daysinplace.azurewebsites.net/api/user/restorePassword', CAST(N'2018-10-07T12:04:10.020' AS DateTime), CAST(N'2018-10-07T12:04:10.020' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (31, N'NOTIFICATION_CONFIRMATION', N'В данный момент, ваше местоположения - {0}?', CAST(N'2018-10-21T09:24:55.903' AS DateTime), CAST(N'2018-10-21T09:24:55.903' AS DateTime))
GO
...
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (34, N'COUNTRY_API_GET_URL', N'https://daysinplace.azurewebsites.net/api/country/get?id={0}', CAST(N'2018-09-16T07:28:48.533' AS DateTime), CAST(N'2018-09-16T07:28:48.533' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (35, N'USERTRACKINGSCHEDULE_API_GET_URL', N'https://daysinplace.azurewebsites.net/api/usertrackingschedule/get?id={0}', CAST(N'2018-11-12T15:27:25.937' AS DateTime), CAST(N'2018-11-12T15:27:25.937' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (36, N'USERTRACKINGSCHEDULE_API_LIST_URL', N'https://daysinplace.azurewebsites.net/api/usertrackingschedule/list?userId={0}', CAST(N'2018-11-12T15:27:25.937' AS DateTime), CAST(N'2018-11-12T15:27:25.937' AS DateTime))
GO
INSERT [conf].[Settings] ([Id], [Key], [Value], [CreatedOn], [ModifiedOn]) VALUES (37, N'USERTRACKINGSCHEDULE_API_ADDEDIT_URL', N'https://daysinplace.azurewebsites.net/api/usertrackingschedule/addEdit', CAST(N'2018-11-12T15:27:25.937' AS DateTime), CAST(N'2018-11-12T15:27:25.937' AS DateTime))
GO
